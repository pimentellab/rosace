...
If you have cloned the git repository locally, navigate to the __rosace__ folder and type:
...
To visualize the results, refer to the *Visualizing functional score results* vignette.
